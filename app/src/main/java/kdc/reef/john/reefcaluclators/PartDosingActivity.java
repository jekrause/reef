...
public class PartDosingActivity extends AppCompatActivity {
    ...
    public void calculateDoseButton(View view){
        ...
        if(correctSettings()){
            try {
                ...
                Toast.makeText(PartDosingActivity.this, "Invalid. Enter an Integer", Toast.LENGTH_SHORT).show();
            }
            if(cb1.isChecked()){
                if(cbFO.isChecked()){
    ...
    public boolean correctSettings(){
        ...
        Toast.makeText(PartDosingActivity.this, "You must select 1 recipe and 1 tank type.", Toast.LENGTH_SHORT).show();
        return false;
